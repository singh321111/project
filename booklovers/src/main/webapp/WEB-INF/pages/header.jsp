...
<div class="container-fluid">
   <ul class="nav navbar-nav navbar-right">
	 ...
	 <a class="navbar-brand" href="#"><img src="${pageContext.request.contextPath}/resources/images/book-lover-logo.png" alt="logo" style="height:80px; weidth:80px; padding:0;"></a>
  </div>
